...
class _CitizenDashboardState extends ConsumerState<CitizenDashboard> {
  ...
  String? _normalizeDistrictName(String? raw) {
    ...
    // Contains/partial match
    for (final district in apDistricts) {
      if (cleaned.contains(district.toLowerCase()) ||
          district.toLowerCase().contains(cleaned)) {
        return district;
      }
    }
  ...
  void initState() {
    ...
    stateDistricts = map;
    // Load states from service - defer to avoid build-time modification
        ...
        boxShadow: [
          BoxShadow(
            color: isDarkMode
                ...
                : const Color(
                    0xFF4CAF50,
                  ).withOpacity(0.08), // Very subtle shadow
            blurRadius: 20,
            offset: const Offset(0, 8),
          ),
          BoxShadow(
                    ...
                    gradient: LinearGradient(
                      colors: isDarkMode
                          ...
                          : [
                              const Color(
                                0xFF4CAF50,
                              ).withOpacity(0.1), // Softer green
                              const Color(
                                0xFF66BB6A,
                              ).withOpacity(0.05), // Very light green
                            ],
                      begin: Alignment.topLeft,
                      end: Alignment.bottomRight,
                    ),
        ...
        gradient: LinearGradient(
          colors: Theme.of(context).brightness == Brightness.dark
              ...
              : [
                  const Color(
                    0xFFFAFAFA,
                  ).withOpacity(0.9), // Very light background
        ...
        boxShadow: [
          BoxShadow(
            color: Theme.of(context).brightness == Brightness.dark
                ...
                : const Color(
                    0xFF4CAF50,
                  ).withOpacity(0.03), // Very subtle shadow
            blurRadius: 10,
            offset: const Offset(0, 4),
          ),
        ],
                  ...
                  gradient: LinearGradient(
                    colors: Theme.of(context).brightness == Brightness.dark
                        ...
                        : [
                            const Color(
                              0xFF4CAF50,
                            ).withOpacity(0.08), // Very subtle green
                            const Color(
                              0xFF66BB6A,
                            ).withOpacity(0.04), // Even more subtle
                          ],
                    begin: Alignment.topLeft,
                    end: Alignment.bottomRight,
                  ),
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: Theme.of(context).brightness == Brightness.dark
                    ...
                    : const Color(
                        0xFFF5F5F5,
                      ).withOpacity(0.6), // Softer light background
                borderRadius: BorderRadius.circular(8),
                border: Border.all(
                  color: Theme.of(context).brightness == Brightness.dark
                      ? const Color(0xFF0CFF0C).withOpacity(0.1)
                      : const Color(
                          0xFF4CAF50,
                        ).withOpacity(0.08), // Very subtle border
                ),
              ),
              child: Text(
  ...
  Widget _buildManualSelectionDropdowns() {
    ...
    final isDarkMode = Theme.of(context).brightness == Brightness.dark;
    final List<String> stateItems = searchState.states.isNotEmpty
        ? searchState.states
        : indianStates;
    ...
    return Container(
      ...
      child: Column(
        ...
        children: [
          ...
          _buildDropdown('State', selectedState, stateItems, (value) {
            setState(() {
              selectedState = value;
              selectedDistrict = null;
              selectedCity = null;
            });
            // Defer provider call to avoid build-time modification
            if (value != null &&
                value.isNotEmpty &&
          ...
          const SizedBox(height: 16),
          _buildDropdown('District', selectedDistrict, districtItems, (value) {
            setState(() {
            ...
            boxShadow: [
              BoxShadow(
                color: isDarkMode
                    ...
                    : const Color(
                        0xFF4CAF50,
                      ).withOpacity(0.05), // Very subtle shadow
                blurRadius: 8,
            ...
            child: DropdownButton<String>(
              ...
              hint: Text(
                ...
                style: TextStyle(
                  color: isDarkMode
                      ? Colors.white70
                      : const Color(0xFF666666), // Softer gray
                  fontSize: 16,
                ),
              ),
              isExpanded: true,
                  ...
                  child: Container(
                    ...
                    child: Text(
                      ...
                      style: TextStyle(
                        color: isDarkMode
                            ? Colors.white
                            : const Color(0xFF333333), // Darker text
                        fontSize: 16,
                        fontWeight: FontWeight.w500,
                      ),
                    ),
  ...
  String _getTrafficSignalDescription() {
    switch (_getTrafficSignalLevel()) {
      case 'good':
        return 'Water levels are healthy and sustainable';
      case 'warning':
        return 'Water levels are declining, monitor closely';
      case 'critical':
        return 'Water levels critically low, immediate action needed';
      default:
        return 'Water levels are healthy and sustainable';
    }
  }
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              ...
              decoration: BoxDecoration(
                color: _getForecastTrendColor().withOpacity(
                  isDarkMode ? 0.2 : 0.1,
                ),
                borderRadius: BorderRadius.circular(8),
              ),
        ...
        child: Column(
          ...
          children: [
            ...
            Container(
              padding: const EdgeInsets.symmetric(horizontal: 8, vertical: 4),
              decoration: BoxDecoration(
                color: _getDayForecastTrendColor().withOpacity(
                  isDarkMode ? 0.2 : 0.1,
                ),
                borderRadius: BorderRadius.circular(8),
              ),
    ...
    return SizedBox(
      ...
      child: ElevatedButton(
        ...
        child: Row(
          ...
          children: [
            Icon(
              showAnalytics ? Icons.visibility_off : Icons.analytics,
              size: 24,
            ),
            const SizedBox(width: 12),
            Text(
            ...
            const SizedBox(width: 8),
            Icon(
              showAnalytics ? Icons.keyboard_arrow_up : Icons.arrow_forward,
              size: 20,
            ),
          ],
        ),
